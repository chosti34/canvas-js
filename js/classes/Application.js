...
Application.prototype.getParamsAndDrawRectangle = function()
{
    ...
    this.canvas.print("Area: " + this.rectangle.calculateArea().toFixed(2), 460, 430);
    this.canvas.print("Perimeter: " + this.rectangle.calculatePerimeter().toFixed(2), 460, 460);
...
Application.prototype.getParamsAndDrawTriangle = function()
{
    ...
    this.canvas.print("Area: " + this.triangle.calculateArea().toFixed(2), 460, 430);
    this.canvas.print("Perimeter: " + this.triangle.calculatePerimeter().toFixed(2), 460, 460);
...
Application.prototype.getParamsAndDrawCircle = function()
{
    ...
    this.canvas.print("Area: " + this.circle.calculateArea().toFixed(2), 450, 430);
    this.canvas.print("Perimeter: " + this.circle.calculatePerimeter().toFixed(2), 450, 460);
